    ...
    try {
      ...
      setChartData(
        [
          {
            type: "line",
            label: data?.products[0]?.product?.name,
          ...
          {
            type: "line",
            label: data?.products[1]?.product?.name,
          ...
          {
            type: "line",
            label: data?.products[2]?.product?.name,
